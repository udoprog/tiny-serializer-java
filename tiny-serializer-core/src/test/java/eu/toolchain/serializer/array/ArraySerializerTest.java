...
public class ArraySerializerTest {
    ...
    public void testBoolean() throws IOException {
        ...
        assertEquals(2, Helpers
            .roundtripArray(booleanArray, new boolean[]{true, false, true})
            .getCaptured()
            .size());

        assertEquals(3, Helpers
            .roundtripArray(booleanArray, new boolean[]{
    ...
    public void testDouble() throws IOException {
        ...
        assertEquals(9,
            Helpers.roundtripArray(doubleArray, new double[]{-1.0d}).getCaptured().size());
        assertEquals(9, Helpers
            .roundtripArray(doubleArray, new double[]{Double.MIN_VALUE})
            .getCaptured()
            .size());
        assertEquals(9, Helpers
            .roundtripArray(doubleArray, new double[]{Double.MAX_VALUE})
            .getCaptured()
            .size());
    }
