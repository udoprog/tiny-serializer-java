...
public final class Fields_Serializer implements Serializer<Fields> {
    ...
    public Fields deserialize(final SerialReader buffer) throws IOException {
        ...
        return new Fields(v_string, v_requiredCustom, v_bool, v_byteNumber, v_shortNumber, v_integer, v_longNumber,
                v_floatNumber, v_doubleNumber, v_character, v_uuid, v_byteArray, v_charArray, v_enumValue);
    }
}
