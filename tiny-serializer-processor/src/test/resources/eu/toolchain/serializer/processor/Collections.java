...
public class Collections {
  ...
  public Collections(
    List<Interface> list, Map<String, Interface> map, SortedMap<String, Interface> sortedMap,
    NavigableMap<String, Interface> navigableMap, Set<Interface> set,
    SortedSet<Interface> sortedSet, NavigableSet<Interface> navigableSet
  ) {
    this.list = list;
    this.map = map;
